...
function evaluateBasicData(data) {
  ...
  var country = '<h3>' + lastElement.Country + '</h3>'
  var template = '';

  template += '<li><strong>Active: </strong>' + lastElement.Active + '</li>';
  template += '<li><strong>Confirmed: </strong>' + lastElement.Confirmed + '</li>';
  template += '<li><strong>Recoveries: </strong>' + lastElement.Recovered + '</li>';
  template += '<li><strong>Deaths: </strong>' + lastElement.Deaths + '</li>';
...
function evaluatePremiumData(data) {
  const lastElement = data[data.length - 1];
  var country = '<h3>' + lastElement.Country + '</h3>'
  var date = '<h4>' + new Date(lastElement.Date).toLocaleDateString() + '</h4>';
  var template = '';

  template += '<li><strong>Case Fatality Ratio: </strong>' + lastElement.CaseFatalityRatio + '</li>';
  template += '<li><strong>New Cases: </strong>' + lastElement.NewCases + '</li>';
  template += '<li><strong>New Cases per Million: </strong>' + lastElement.NewCasesPerMillion + '</li>';
  template += '<li><strong>New Deaths: </strong>' + lastElement.NewDeaths + '</li>';
  template += '<li><strong>New Deaths per Million: </strong>' + lastElement.NewDeathsPerMillion + '</li>';
  template += '<li><strong>Total Cases: </strong>' + lastElement.TotalCases + '</li>';
  template += '<li><strong>Total Cases per Million: </strong>' + lastElement.TotalCasesPerMillion + '</li>';
  template += '<li><strong>Total Deaths: </strong>' + lastElement.TotalDeaths + '</li>';
  template += '<li><strong>Total Deaths per Million: </strong>' + lastElement.TotalDeathsPerMillion + '</li>';
...
function evaluateCountryData(data) {
  ...
  template += '<li><strong>Population: </strong>' + lastElement.Population + '</li>';
  template += '<li><strong>Population Density: </strong>' + lastElement.PopulationDensity + '</li>';
  template += '<li><strong>Median Age: </strong>' + lastElement.MedianAge + '</li>';
  template += '<li><strong>Aged 65 or Older: </strong>' + lastElement.Aged65Older + '</li>';
  template += '<li><strong>Aged 70 or Older: </strong>' + lastElement.Aged70Older + '</li>';
